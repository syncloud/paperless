...
# Version 2.11 UI helpers
def login_2_11(selenium, device_user, device_password):
    selenium.open_app()
...
def upload_document_2_11(selenium, mode):
    selenium.open_app()
...
def check_document_list_2_11(selenium, mode):
